...
export const ga: Messages = {
  ...
  waitingForHostNamed: (p: string) => `Tosóidh ${p} an cluiche nuair a bheidh cách anseo`,
  ...
  bid: 'Tairiscint',
  tricks: 'Cleasa',
  lastTrick: 'An cleas deireanach',
  spreadHand: 'Leath na cártaí',
  collapseHand: 'Cnuasaigh na cártaí',
  ...
  playerPaused: (p: string) => `${p} ag glacadh sosa`,
  playerResumed: (p: string) => `${p} ar ais sa chluiche`,
  ...
  phrases: 'Teachtaireachtaí',
  phraseTexts: {
    nice: 'Imirt mhaith!',
    oops: 'Úps…',
    yourTurn: 'Do sheal!',
    hurry: 'Táimid ag fanacht 🙂',
    watchTrump: 'Aire don mhámh',
    mine: 'Is liomsa an ceann sin',
    sorry: 'Tá brón orm!',
    brb: 'Ar ais i gceann nóiméid',
    goodGame: 'Cluiche maith!',
    again: 'Ceann eile?',
  },
  pauseGame: 'Sos a ghlacadh',
  resumePlay: 'Táim ar ais',
  pausedTag: 'ar sos',
  pauseHint: 'Coinníonn róbat do shuíochán agus tú as láthair.',
  close: 'Dún',
  ...
  rulesScoreOkFormula: '10 + 2 × cleas',
  rulesScoreKoFormula: '−2 × difríocht',
  pseudoPlaceholder: 'Máire, Cáirim, Lia…',
