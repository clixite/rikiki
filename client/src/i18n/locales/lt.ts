...
export const lt: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} pradės žaidimą, kai visi susirinks`,
  ...
  bid: 'Užsakymas',
  tricks: 'Kirčiai',
  lastTrick: 'Paskutinis kirtis',
  spreadHand: 'Išskleisti kortas',
  collapseHand: 'Sudėti kortas',
  ...
  playerPaused: (p: string) => `${p} daro pertrauką`,
  playerResumed: (p: string) => `${p} grįžta į žaidimą`,
  ...
  phraseTexts: {
    ...
    yourTurn: 'Tavo eilė!',
    hurry: 'Laukiame 🙂',
    watchTrump: 'Saugokis kozirio',
    mine: 'Šitas mano',
    sorry: 'Atsiprašau!',
    brb: 'Tuoj grįšiu',
    goodGame: 'Puikus žaidimas!',
    again: 'Dar vieną?',
  },
  pauseGame: 'Padaryti pertrauką',
  resumePlay: 'Grįžau',
  pausedTag: 'pertrauka',
  pauseHint: 'Kol tavęs nėra, tavo vietą laiko robotas.',
  close: 'Uždaryti',
  ...
  rulesScoreOkFormula: '10 + 2 × kirčiai',
  rulesScoreKoFormula: '−2 × skirtumas',
  pseudoPlaceholder: 'Marija, Karimas, Lėja…',
  ...
  leftHandedMode: 'Valdikliai kairėje',
  leftHandedHint: 'Perkelia stalo mygtukus iš dešiniojo krašto į kairįjį.',
  colorblindHintBanner: 'Spalvaaklis? Išbandyk atskiras spalvas savo profilyje.',
