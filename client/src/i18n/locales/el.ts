...
export const el: Messages = {
  ...
  rulesScoreOkFormula: '10 + 2 × μπάζες',
  rulesScoreKoFormula: '−2 × διαφορά',
  pseudoPlaceholder: 'Μαρία, Καρίμ, Λέα…',
  ...
  leftHandedMode: 'Χειρισμός αριστερά',
  leftHandedHint: 'Μετακινεί τα κουμπιά του τραπεζιού από τη δεξιά στην αριστερή άκρη.',
  colorblindHintBanner: 'Αχρωματοψία; Δοκίμασε τα διακριτά χρώματα στο προφίλ σου.',
  suitNames: {
    S: 'μπαστούνι',
    H: 'κούπα',
    D: 'καρό',
