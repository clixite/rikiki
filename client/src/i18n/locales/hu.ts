...
export const hu: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} indítja a játékot, ha mindenki megjött`,
  ...
  bid: 'Bemondás',
  tricks: 'Ütések',
  lastTrick: 'Utolsó ütés',
  spreadHand: 'Lapok szétterítése',
  collapseHand: 'Lapok összezárása',
  ...
  playerPaused: (p: string) => `${p} szünetet tart`,
  playerResumed: (p: string) => `${p} visszatért a játékba`,
  ...
  pauseGame: 'Szünetet tartok',
  resumePlay: 'Visszatértem',
  pausedTag: 'szünetel',
  pauseHint: 'Egy robot tartja a helyed, amíg szünetelsz.',
  close: 'Bezárás',
  ...
  rulesScoreOkFormula: '10 + 2 × ütés',
  rulesScoreKoFormula: '−2 × eltérés',
  pseudoPlaceholder: 'Mária, Karim, Lea…',
