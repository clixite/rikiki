...
export const sv: Messages = {
  ...
  rulesScoreOkFormula: '10 + 2 × stick',
  rulesScoreKoFormula: '−2 × differens',
  ...
  leftHandedMode: 'Styrning till vänster',
  leftHandedHint: 'Flyttar bordets knappar från högerkanten till vänsterkanten.',
  colorblindHintBanner: 'Färgblind? Prova egna färger i din profil.',
