...
export const lv: Messages = {
  ...
  rulesScoreOkFormula: '10 + 2 × stiķi',
  rulesScoreKoFormula: '−2 × starpība',
  pseudoPlaceholder: 'Marija, Karims, Lea…',
  ...
  leftHandedMode: 'Vadīklas pa kreisi',
  leftHandedHint: 'Pārvieto galda pogas no labās malas uz kreiso.',
  colorblindHintBanner: 'Krāsaklis? Izmēģini atšķirīgas krāsas savā profilā.',
