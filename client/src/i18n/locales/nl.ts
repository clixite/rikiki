...
export const nl: Messages = {
  ...
  rulesScoreOkFormula: '10 + 2 × slagen',
  rulesScoreKoFormula: '−2 × verschil',
  ...
  leftHandedMode: 'Bediening links',
  leftHandedHint: 'Verplaatst de knoppen van de tafel van de rechterrand naar de linkerrand.',
  colorblindHintBanner: 'Kleurenblind? Probeer aparte kleuren in je profiel.',
