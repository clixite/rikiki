...
export const pt: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} começa a partida quando estiverem todos`,
  ...
  gameSettingsHint: 'O anfitrião escolhe antes de começar',
  gameSettingsLocked: 'Definições escolhidas pelo anfitrião',
  ...
  gamePace: 'Ritmo',
  gamePaceHint: 'Juntos, ou cada um quando puder',
  paceNames: {
    live: 'Em direto',
    async: 'Ao teu ritmo',
  },
  paceDescriptions: {
    live: 'Todos jogam ao mesmo tempo; uma vez demasiado longa joga-se sozinha.',
    async: 'Cada um joga quando pode, ao longo de dias. Ninguém joga por ti.',
  },
  paceLocked: 'Ritmo escolhido pelo anfitrião',
  waitingForPlayer: (pseudo: string) => `À espera de ${pseudo}`,
  waitingToStart: 'À espera do início',
  ...
  bid: 'Aposta',
  tricks: 'Vazas',
  lastTrick: 'Última vaza',
  spreadHand: 'Espalhar as cartas',
  collapseHand: 'Juntar as cartas',
  ...
  playerPaused: (p: string) => `${p} está a fazer uma pausa`,
  playerResumed: (p: string) => `${p} voltou à partida`,
  ...
  phraseTexts: {
    ...
    oops: 'Ups…',
    yourTurn: 'É a tua vez!',
    hurry: 'Estamos à espera 🙂',
    watchTrump: 'Atenção ao trunfo',
    mine: 'Essa é minha',
    sorry: 'Desculpa!',
    brb: 'Volto já',
    goodGame: 'Boa partida!',
    again: 'Mais uma?',
  },
  pauseGame: 'Fazer uma pausa',
  resumePlay: 'Já voltei',
  pausedTag: 'em pausa',
  pauseHint: 'Um robô fica com o teu lugar enquanto estiveres fora.',
  close: 'Fechar',
  ...
  contractsKept: 'Contratos cumpridos',
  ...
  rulesScoreOkFormula: '10 + 2 × vazas',
  rulesScoreKoFormula: '−2 × diferença',
  pseudoPlaceholder: 'Maria, Karim, Lia…',
  ...
  leftHandedMode: 'Controlos à esquerda',
  leftHandedHint: 'Move os botões da mesa da borda direita para a esquerda.',
  colorblindHintBanner: 'Daltónico? Experimenta as cores distintas no teu perfil.',
