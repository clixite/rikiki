...
export const fi: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} aloittaa pelin, kun kaikki ovat paikalla`,
  ...
  bid: 'Tarjous',
  tricks: 'Tikit',
  lastTrick: 'Viimeisin tikki',
  spreadHand: 'Levitä kortit',
  collapseHand: 'Kokoa kortit',
  ...
  playerPaused: (p: string) => `${p} pitää tauon`,
  playerResumed: (p: string) => `${p} on taas mukana`,
  ...
  phraseTexts: {
    ...
    oops: 'Hups…',
    yourTurn: 'Sinun vuorosi!',
    hurry: 'Odotamme sinua 🙂',
    watchTrump: 'Varo valttia',
    mine: 'Tuo on minun',
    sorry: 'Anteeksi!',
    brb: 'Palaan pian',
    goodGame: 'Hyvä peli!',
  ...
  pauseGame: 'Pidä tauko',
  resumePlay: 'Olen takaisin',
  pausedTag: 'tauolla',
  pauseHint: 'Robotti pitää paikkasi tauon ajan.',
  close: 'Sulje',
  ...
  rulesScoreOkFormula: '10 + 2 × tikkiä',
  rulesScoreKoFormula: '−2 × erotus',
  ...
  leftHandedMode: 'Ohjaimet vasemmalle',
  leftHandedHint: 'Siirtää pöydän painikkeet oikeasta reunasta vasempaan.',
  colorblindHintBanner: 'Värisokea? Kokeile omia värejä profiilissasi.',
