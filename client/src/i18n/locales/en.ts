...
export const en: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} starts the game when everyone is here`,
  ...
  spreadHand: 'Spread my cards',
  collapseHand: 'Collapse my cards',
  ...
  playerPaused: (p: string) => `${p} is taking a break`,
  playerResumed: (p: string) => `${p} is back at the table`,
  ...
  phraseTexts: {
    ...
    yourTurn: 'Your turn!',
    hurry: 'We’re waiting 🙂',
    watchTrump: 'Watch the trump',
    mine: 'That one’s mine',
    sorry: 'Sorry!',
    brb: 'Back in a minute',
    goodGame: 'Good game!',
    again: 'One more?',
  },
  pauseGame: 'Take a break',
  resumePlay: 'I’m back',
  pausedTag: 'on a break',
  pauseHint: 'A bot holds your seat while you’re away.',
  close: 'Close',
  ...
  rulesScoreOkFormula: '10 + 2 × tricks',
  rulesScoreKoFormula: '−2 × gap',
  pseudoPlaceholder: 'Mary, Karim, Lea…',
  ...
  leftHandedMode: 'Left-handed controls',
  leftHandedHint: 'Moves the table’s buttons from the right edge to the left.',
  colorblindHintBanner: 'Colour-blind? Try distinct colours in your profile.',
