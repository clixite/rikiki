...
export const mt: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} jibda l-logħba meta jkun hemm kulħadd`,
  ...
  bid: 'Tħabbira',
  tricks: 'Daqqiet',
  lastTrick: 'L-aħħar id',
  spreadHand: 'Ifrex il-karti',
  collapseHand: 'Iġbor il-karti',
  ...
  phraseTexts: {
    ...
    oops: 'Ajma…',
    yourTurn: 'Imissek int!',
    hurry: 'Qed nistennewk 🙂',
    watchTrump: 'Attent għall-briskola',
    mine: 'Dik tiegħi',
    sorry: 'Skużani!',
    brb: 'Nerġa’ niġi mill-ewwel',
    goodGame: 'Logħba sabiħa!',
    again: 'Oħra?',
  },
  pauseGame: 'Ħu waqfa',
  resumePlay: 'Erġajt ġejt',
  pausedTag: 'bi waqfa',
  pauseHint: 'Robot iżomm postok waqt li tkun barra.',
  close: 'Agħlaq',
  ...
  rulesScoreOkFormula: '10 + 2 × idejn',
  rulesScoreKoFormula: '−2 × differenza',
  pseudoPlaceholder: 'Marija, Karim, Lea…',
