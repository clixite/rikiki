...
export const es: Messages = {
  ...
  rulesScoreOkFormula: '10 + 2 × bazas',
  rulesScoreKoFormula: '−2 × diferencia',
  pseudoPlaceholder: 'María, Karim, Lea…',
  ...
  leftHandedMode: 'Controles a la izquierda',
  leftHandedHint: 'Mueve los botones de la mesa del borde derecho al izquierdo.',
  colorblindHintBanner: '¿Daltónico? Prueba los colores distintos en tu perfil.',
