...
export const de: Messages = {
  ...
  waitingForHostNamed: (p: string) => `${p} startet die Partie, sobald alle da sind`,
  ...
  gameSettingsHint: 'Der Gastgeber wählt vor dem Start',
  gameSettingsLocked: 'Einstellungen vom Gastgeber gewählt',
  settingsDone: 'Fertig',
  ...
  spreadHand: 'Karten auffächern',
  collapseHand: 'Karten zusammenlegen',
  ...
  playerPaused: (p: string) => `${p} macht eine Pause`,
  playerResumed: (p: string) => `${p} spielt wieder mit`,
  ...
  phraseTexts: {
    ...
    yourTurn: 'Du bist dran!',
    hurry: 'Wir warten 🙂',
    watchTrump: 'Achtung, Trumpf',
    mine: 'Der gehört mir',
    sorry: 'Tut mir leid!',
    brb: 'Bin gleich zurück',
    goodGame: 'Schöne Partie!',
    again: 'Noch eine?',
  },
  pauseGame: 'Pause machen',
  resumePlay: 'Ich bin zurück',
  pausedTag: 'pausiert',
  pauseHint: 'Ein Bot hält deinen Platz, solange du weg bist.',
  close: 'Schließen',
  ...
  rulesScoreOkFormula: '10 + 2 × Stiche',
  rulesScoreKoFormula: '−2 × Differenz',
  pseudoPlaceholder: 'Marie, Karim, Lea…',
  ...
  leftHandedMode: 'Bedienung links',
  leftHandedHint: 'Verschiebt die Tischtasten vom rechten zum linken Rand.',
  colorblindHintBanner: 'Farbenblind? Probiere eigene Farben in deinem Profil.',
